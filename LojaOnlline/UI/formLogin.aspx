<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="formLogin.aspx.cs" Inherits="LojaOnlline.UI.formLogin" %>
    ...
    <form id="form1" class="form-signin" runat="server">
        <div class="container">
            <div class="form-group">
                <asp:Image ImageUrl="~/IMG/download.jpg" AlternateText="Imagem não carregada" class="img-thumbnail" runat="server" />
